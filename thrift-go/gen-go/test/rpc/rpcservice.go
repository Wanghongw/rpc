...
type RpcService interface {
	...
	//  - CallTime
	//  - ParamMap
	FunCall(callTime int64, paramMap map[string]string) (r []string, err error)
}
...
//  - CallTime
//  - ParamMap
func (p *RpcServiceClient) FunCall(callTime int64, paramMap map[string]string) (r []string, err error) {
	if err = p.sendFunCall(callTime, paramMap); err != nil {
		return
	}
	return p.recvFunCall()
}

func (p *RpcServiceClient) sendFunCall(callTime int64, paramMap map[string]string) (err error) {
...
func (p *rpcServiceProcessorFunCall) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval []string
	var err2 error
	if retval, err2 = p.handler.FunCall(args.CallTime, args.ParamMap); err2 != nil {
...
func (p *RpcServiceFunCallArgs) writeField2(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("paramMap", thrift.MAP, 2); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:paramMap: ", p), err)
	}
	...
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 2:paramMap: ", p), err)
	}
	return err
}
