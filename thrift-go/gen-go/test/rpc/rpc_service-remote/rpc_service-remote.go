...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "   funCall(i64 callTime,  paramMap)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	case "funCall":
		if flag.NArg()-1 != 2 {
			fmt.Fprintln(os.Stderr, "FunCall requires 2 args")
			flag.Usage()
		}
		...
		containerStruct1 := rpc.NewRpcServiceFunCallArgs()
		err13 := containerStruct1.ReadField2(jsProt12)
		if err13 != nil {
			Usage()
			return
		}
		...
		value1 := argvalue1
		fmt.Print(client.FunCall(value0, value1))
		fmt.Print("\n")
		break
	case "":
		Usage()
